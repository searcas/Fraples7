...
public:
	...
	static void DrawQuad(const glm::mat4& transform, const glm::vec2& size, const std::shared_ptr<Texture2D>& Texture, float tiling = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
