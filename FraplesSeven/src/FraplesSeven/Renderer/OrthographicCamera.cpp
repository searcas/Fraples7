...
namespace Fraples
{
	OrthographicCamera::OrthographicCamera(float left, float right, float bottom, float top) : _mProjectionMatrix(glm::ortho(left, right, bottom, top, -1.0f, 1.0f)), _mViewMatrix(1.0f)
	{
